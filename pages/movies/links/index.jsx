              ...
              <div className="row">
                <div className="col-12">
                  <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 className="mb-sm-0 font-size-18">Movies On Database</h4>
                    <form
                    ...
                    {movies.map((e, i) => (
                      <div className="col-md-2 col-xl-2 col-4" key={i}>
                        <div style={{ height: "100%" }} className="card">
                          ...
                          <a
                            role="button"
                            onClick={() => router.push(`links/${e.tmdbId}`)}
                            className="btn btn-primary waves-effect waves-light m-2"
                          >
                            <i className="bx bx-plus-medical"></i> ADD LINKS
                          </a>
                        </div>
                      </div>
                    ))}
